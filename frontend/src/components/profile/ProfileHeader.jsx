		...
		<div className='bg-white shadow rounded-lg mb-6'>
			...
			<div className='p-4'>
				<div className='relative -mt-20 mb-4 '>
					...
					{isEditing && (
						<label className='absolute bottom-0  transform translate-x-16 bg-white p-2 rounded-full shadow cursor-pointer'>
							<Camera size={20} />
							<input
								type='file'
								className='hidden'
				...
				<div>
					...
					{isEditing ? (
						<input
							...
							className='text-gray-600 text-center w-full border'
						/>
					) : (
				...
				{!isEditing && (<div className="text-gray-500 mt-6">
					<span className="me-4">followers: {userData.followers.length}</span>
				...
				{isOwnProfile ? (
					isEditing ? (
						<button
							...
							onClick={handleSave}
						>
							<ClipboardCheck className="size-4" />Save Profile
						</button>
					) : (
						<button
